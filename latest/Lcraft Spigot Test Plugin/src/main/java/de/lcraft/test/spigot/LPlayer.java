...
public class LPlayer extends de.lcraft.api.minecraft.spigot.module.manager.utils.LPlayer {
	...
	public void onSendChatMessage(String msg) {
		for(de.lcraft.api.minecraft.spigot.module.manager.utils.LPlayer c : SpigotClass.getAPIPluginMain().getPlayers()) {
			if(c.isOnline()) {
	...
	@Override
	public String onGetChatMessage(de.lcraft.api.minecraft.spigot.module.manager.utils.LPlayer from, String msg) {
