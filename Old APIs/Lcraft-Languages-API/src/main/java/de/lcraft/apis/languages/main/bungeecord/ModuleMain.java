...
public class ModuleMain extends Module {
    ...
    public void onLoad() throws IOException {
        languagesManager = new de.lcraft.apis.languages.system.bungeecord.filesystem.LanguagesManager(this, new ModuleCommandManager(new de.lcraft.api.plugin.utils.minecraft.bungeecord.module.commands.ModuleCommandManager(this)));
    }
