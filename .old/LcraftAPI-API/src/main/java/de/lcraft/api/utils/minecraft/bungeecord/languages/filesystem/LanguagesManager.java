package de.lcraft.api.utils.minecraft.bungeecord.languages.filesystem;

import de.lcraft.api.utils.minecraft.bungeecord.languages.filesystem.impl.English;
import de.lcraft.api.utils.minecraft.bungeecord.languages.filesystem.impl.German;
...
public class LanguagesManager {
    ...
    public LanguagesManager() throws IOException {
        langs = new ArrayList<>();
        userCFG = new ModuleConfig("Lcraft Languages", "users.yml");
        cfg = new ModuleConfig("Lcraft Languages", "config.yml");

        addLang(new German());
        addLang(new English());

        /*for(Language lang : langs) {
            for(String c : moduleManager.get.getAllTranslatedTexts()) {
                lang.translate(c);
            }
        }*/
    }
    ...
    public Language getDefaultLanguage() throws IOException {
        if(cfg.cfg().contains("langs.default")) {
            cfg.cfg().set("langs.default", new English().getShort());
            cfg.save();
        } else {
