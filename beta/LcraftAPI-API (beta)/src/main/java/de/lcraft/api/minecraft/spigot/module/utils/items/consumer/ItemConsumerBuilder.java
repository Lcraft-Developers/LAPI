...
public class ItemConsumerBuilder extends ItemBuilder {
    ...
    public ItemConsumerBuilder(Material material, int amount, ListenerManager manager, Consumer<InventoryClickEvent> rightClickConsumer, Consumer<InventoryClickEvent> leftClickConsumer) {
    ...
    public ItemConsumerBuilder(Material m, ListenerManager manager, Consumer<InventoryClickEvent> rightClickConsumer, Consumer<InventoryClickEvent> leftClickConsumer) {
        this(m, 1, manager, rightClickConsumer, leftClickConsumer);
    }
