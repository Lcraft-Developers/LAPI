...
public class ConfigTest {
	...
	public static void main(String[] args) {
		Config cfg1 = new Config("test.yml", new EasyConfigFileWriter());
		cfg1.load();
		cfg1.set("test.lpd", 2);
		cfg1.set("test", 1);
		...
		Config cfg2 = new Config("test.yml", new EasyConfigFileWriter());
		cfg2.load();
		...
		Config cfg3 = new Config("test.yml", new YAMLConfigFileWriter());
		cfg3.load();
		cfg3.set("test.lpd", 2);
		cfg3.set("test", 1);
		...
		Config cfg4 = new Config("test.yml", new YAMLConfigFileWriter());
		cfg4.load();
