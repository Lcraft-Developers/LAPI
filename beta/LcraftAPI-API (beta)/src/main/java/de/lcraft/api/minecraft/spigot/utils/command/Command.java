...
public abstract class Command extends org.bukkit.command.Command implements Listener {
    ...
    public Command(StandardMessages standardMessages, String label, String desc, PermsManager permsManager, LPlayerManager lPlayerManager, LanguagesManager languagesManager, boolean splitting, ListenerManager listenerManager) {
