...
public class LanguagesManager {
	...
	public LanguagesManager(Module module) throws IOException {
		fileConfig = new ModuleConfig(module, "Lcraft Languages", "config.yml");
		userConfig = new ModuleConfig(module, "Lcraft Languages", "users.yml");
