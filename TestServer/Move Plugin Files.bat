...
del ".\Spigot\plugins\LcraftAPI.API-1.0.1.jar"

del ".\Spigot\lmodules\LcraftAPI.spigot.test-1.0.0.jar"


echo Copy Spigot Versions
copy "..\LcraftAPI-API\target\LcraftAPI.API-1.0.1.jar" ".\Spigot\plugins\"
...
del ".\BungeeCord\plugins\LcraftAPI.API-1.0.1.jar"

del ".\BungeeCord\lmodules\LcraftAPI.bungeecord.test-1.0.0.jar"


echo Copy Bungee Versions
copy "..\LcraftAPI-API\target\LcraftAPI.API-1.0.1.jar" ".\BungeeCord\plugins\"
